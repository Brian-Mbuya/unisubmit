...
public class SuspensionEnforcementFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        // /api/v1/** is the stateless JWT chain — it has its own enforcement in
        // JwtSuspensionFilter, and this filter's sendRedirect to an HTML login page
        // would be meaningless to the mobile client anyway.
