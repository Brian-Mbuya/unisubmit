...
public class GlobalExceptionHandler {
    ...
    public Object handleNoResource(Exception ex,
        ...
        // An unmatched /api/v1/** URL has no controller, so ApiExceptionHandler's
        // basePackages scoping cannot catch it and this handler is reached instead.
        // Mobile clients json.decode() every response body — hand them JSON, not the
        // themed HTML error page.
