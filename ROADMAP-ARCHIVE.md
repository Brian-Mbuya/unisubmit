> **ARCHIVED 2026-07-17.** This is the pre-V3 roadmap (captured from branch `main`, commit 92eec36,
> which includes the never-executed "VERSION 2 — THE REGISTRY" art direction — SUPERSEDED by
> ROADMAP.md Phase 1 per owner decision 2026-07-17). Kept verbatim for history: phase logs F/O/Q/M/D/R
> and the Registry spec. Do NOT execute anything in this file.
